...
import com.goodie.library.LibraryApplication;
...
import com.goodie.library.data.prefs.PrefKey;
import com.goodie.library.utils.LocaleUtil;
import com.goodie.library.utils.eventBus.RxBus;
import com.goodie.library.utils.eventBus.RxBusObject;
...
public abstract class BaseActivity extends AppCompatActivity implements Validator.ValidationListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.libraryService = LibraryApplication.getInstance().getOlshopService();
        this.bus = new RxBus();
